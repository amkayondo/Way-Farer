...
var createTrip = function createTrip(req, res) {
  ...
  var data = _trips["default"].tripData(uuid.v4(), req.body.seatingCapacity, req.body.busLicenseNumber, req.body.origin, req.body.destination, req.body.tripDate, req.body.fare, 'active');
  ...
  _joi["default"].validate(inputData, schema, function (error) {
    ...
    _response["default"].successData(res, 201, data);
