...
(0, _mocha.describe)('TRIPS TESTS', function () {
  ...
  (0, _mocha.it)('should return all trips', function (done) {
    _chai["default"].request(_index["default"]).get('/api/v1/trips').end(function (err, res) {
      (0, _chai.expect)(res).to.have.status(200);
      done();
    });
  });
  (0, _mocha.it)('should return trips by destination', function (done) {
    _chai["default"].request(_index["default"]).get('/api/v1/trips').query({
      destination: 'kigali'
    }).end(function (err, res) {
      (0, _chai.expect)(res).to.have.status(200);
      done();
  ...
  (0, _mocha.it)('should return trips by origin', function (done) {
    _chai["default"].request(_index["default"]).get('/api/v1/trips').query({
      origin: 'kampala'
    }).end(function (err, res) {
      (0, _chai.expect)(res).to.have.status(200);
